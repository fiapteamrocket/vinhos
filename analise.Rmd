...
Com o gráfico de correlação descobrimos que:
(Precisamos revisar esse ponto)
***
- Quanto mais `cloreto` menor a qualidade
...
```{r}
pred1 <- predict(modeloSemCitricidade, newdata = test)
RMSE(pred = pred1, obs = test$quality)
```
